...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    if (env === 'production') {
      try {
        ...
        await queryInterface.sequelize.query(`
          ...
          USING CASE 
            ...
            ELSE decode("image", 'base64')
          END;
        `).catch(err => {
          console.log('⚠️ Users.image warning:', err.message);
          console.log('(Có thể bỏ qua nếu cột đã có kiểu dữ liệu đúng hoặc chưa tồn tại)');
        });
        ...
        console.log('Chuyển đổi trường contentHTML và contentMarkdown trong Markdown...');
        await queryInterface.sequelize.query(`
        ...
        console.log('Chuyển đổi trường descriptionHTML và descriptionMarkdown trong Specialties...');
        await queryInterface.sequelize.query(`
          ALTER TABLE "Specialties" 
        ...
        console.log('Chuyển đổi trường descriptionHTML và descriptionMarkdown trong Clinics...');
        await queryInterface.sequelize.query(`
          ALTER TABLE "Clinics" 
          ALTER COLUMN "descriptionHTML" TYPE TEXT,
          ALTER COLUMN "descriptionMarkdown" TYPE TEXT;
      ...
      console.log('Migration này chỉ áp dụng cho môi trường production (PostgreSQL)');
    }
  },
